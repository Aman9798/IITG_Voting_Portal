        ...
        if voter.otp_sent >= 3:
           ...
           # print(otp)
            ...
            try:
               ...
               # msg = "Use " + str(otp)
                print(otp)
                message_is_sent = send_sms(phone, otp)
...
# def send_sms(phone_number, msg, rec_email):
#     """Read More
#     https://www.multitexter.com/developers
#     """
#     import requests
...
#     email = 'roysatish906@gmail.com'
#     password = 'Aman1234'
#     print(email)
#     print(password)
#     API_KEY= 'jV62MLUJCGjUssGVaz2s9QdlrD9uFwMXWfZXqSD1UIyzpg7vmCTD5jexuRNx'
#     # print(password)
...
#     data = {"message": msg,"sender_name": "E-voting", "recipients": phone_number}
#     print(data)
#     #headers = {'Content-type': 'application/json', 'Accept': 'text/plain'}
#     headers = {'Authorization' : 'Bearer jV62MLUJCGjUssGVaz2s9QdlrD9uFwMXWfZXqSD1UIyzpg7vmCTD5jexuRNx', 'Accept': 'application/json'}
